 ...
 */
/*
To generate the JWT token, we need a secret key and the
token expiration time;
these values are read from the application configuration
...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails){
        ...
        extraClaims.put("role", user.getRole()); // Add the role claim
